                            ...
                            <ul id="menu-showhide" class="topnav">
                                ...
                                <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <!-- class="active" -->
                                            <a href="liste_crr_user.php" title="liste">liste</a>
                                        </li>
                                        <li><a href="ajouter_crr_user.php" title="ajouter">
                                            ajouter
                                        </a>
                                        </li>                               
                                    </ul>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body compose_mail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="matricule_textbox"  value="<?php echo $_SESSION['mat'];?>" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label> projet :</label>
                                        <select class="form-control" name="projet_liste_deroulant">
                                           <?php
                                         include '../controller/set_code_libelle_projet.php';
                                         ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mot_cle_textbox"  placeholder="...." class="form-control">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date_d_reunion_textbox"  placeholder="../../.." class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            <label> date de systeme :</label>
                                            <div class="form-group">

                                                <input type="date" name="date_sys_textbox"  placeholder="../../.." class="form-control">
                                            </div>
                                        </div>
                                    ...
                                    <label> liste des invites :</label>
                                    <div class="form-group">

                                        <textarea  type="text" name="liste_des_invites_textbox"  placeholder="...." class="form-control"></textarea>
                                    </div>
                                                ...
                                                <div class="container-fluid">
                                                    ...
                                                    <label> liste des presents :</label>
                                                        <select class="form-control" id="tagPicker" multiple="multiple">
                                                          <?php
                                                             include '../controller/set_liste_present.php';
                                                           ?>                                                       
                                                        </select>
                                                </div>    
                                                <hr>
                                    
                                    <label> proces verbal :</label>
                                    <div class="form-group">

                                        <textarea type="text" rows="6" name="proces_verbal_textbox"  placeholder="...." class="form-control"></textarea>
                                    </div>
                                    ...
                                    <br>
                                        ...
                                        <?php
                                        include '../controller/insert_crr_controller.php';
                                        ?>
                            </div>
                            <!-- /.box-body -->
                        </div>
